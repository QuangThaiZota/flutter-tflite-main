...
class Detector {
  ...
  static const String _labelPath = 'assets/models/labelmodel.txt';
...
class _DetectorServer {
  ...
  static const double confidence = 0.001;
  ...
  Map<String, dynamic> analyseImage(
    ...
    // Location
    final locationsRaw = output[1][0] as List<List<double>>;
    ...
    print("--KẾT QUẢ classesRaw: $classesRaw , $classes ");
    // Scores
    ...
    print("--KẾT QUẢ: $scores , $classification ");
  ...
  List<List<Object>> _runInference(
    ...
    print('--Kết quả ${output.values.toList()}');
